        ...
        <div className="max-w-5xl mx-auto space-y-8 pb-20">
            ...
            <div className="flex gap-3 mb-6">
                <Link
                    ...
                    target="_blank"
                    className="bg-white border border-stone-300 text-stone-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-stone-50 transition-colors flex items-center gap-2"
                >
