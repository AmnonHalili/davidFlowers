...
export default function WhatsAppButton() {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center p-4 bg-[#25D366] text-white rounded-full shadow-xl hover:shadow-2xl transition-shadow group overflow-hidden"
        ...
        >
            ...
            <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-xs transition-all duration-300 ease-out text-sm font-bold mr-0 group-hover:mr-2">
                דברו איתנו
            </span>
        </motion.a>
    );
